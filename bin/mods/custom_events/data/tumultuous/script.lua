...
setProperty('iconP2.antialiasing',false)
    ...
    function onCreatePost()
        makeLuaText("message", "Remake by HappyAppleDay, sprites by LooshGaming, chart by Blokbrine", 500, 30, 50)
        setTextAlignment("message", "left")
        addLuaText("message")
  setTextFont('message', 'COMIC.TTF')
     
        makeLuaText("engineText", "Tumultuous - Blokked Engine (OS 1.5.1)", 500, 30, 30)
