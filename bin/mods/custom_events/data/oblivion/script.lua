...
cameraSetTarget('boyfriend')
    ...
    ofs = 0.2 --how far up or down you want the character to be
...
setProperty('iconP2.antialiasing',false)
    ...
    function onCreatePost()
        makeLuaText("message", "Song by Null_Y34r, chart by Blokbrine and Pixel", 500, 30, 50)
        setTextAlignment("message", "left")
        addLuaText("message")
        setTextFont('message', 'COMIC.TTF')
     
        makeLuaText("engineText", "OBLIVION - Blokked Engine (OS 1.5.1)", 500, 30, 30)
