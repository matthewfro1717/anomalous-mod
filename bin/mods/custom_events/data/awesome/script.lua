...
setProperty('iconP2.antialiasing',false)
    ...
    function onCreatePost()
        makeLuaText("message", "Song by ShiftyTM, sprites by LooshGaming, chart by Blokbrine", 500, 30, 50)
        setTextAlignment("message", "left")
        addLuaText("message")
  setTextFont('message', 'COMIC.TTF')
     
        makeLuaText("engineText", "Awesome - Blokked Engine (OS 1.5.1)", 500, 30, 30)
