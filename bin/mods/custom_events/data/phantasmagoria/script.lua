...
characterPlayAnim('gf', 'scared', true)
    ...
    amplitudeY = 100 --how far up and down it will go in pixels
    amplitudeX = 100 --how far left and right  it will go in pixels
    ofs = 0.1 --how far up or down you want the character to be
...
setProperty('iconP2.antialiasing',false)
    ...
    function onCreatePost()
        makeLuaText("message", "Song by Joolian, chart by Blokbrine", 500, 30, 50)
        setTextAlignment("message", "left")
        addLuaText("message")
  setTextFont('message', 'COMIC.TTF')
     
        makeLuaText("engineText", "Phantasmagoria - Blokked Engine (OS 1.5.1)", 500, 30, 30)
