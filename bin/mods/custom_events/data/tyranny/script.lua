...
characterPlayAnim('gf', 'scared', true)
    ...
    speedY = 0.5 --how fast it will go up and down
    ...
    ofs = 0.5 --how far up or down you want the character to be
...
setProperty('iconP2.antialiasing',false)
    ...
    function onCreatePost()
        makeLuaText("message", "Song by Null_y34r, sprite by NoobGaming, chart by Blokbrine", 500, 30, 50)
        setTextAlignment("message", "left")
        addLuaText("message")
  setTextFont('message', 'COMIC.TTF')
     
        makeLuaText("engineText", "Tyranny - Blokked Engine (OS 1.5.1)", 500, 30, 30)
