...
characterPlayAnim('gf', 'scared', true)
    ...
    ofs = 0.01 --how far up or down you want the character to be
...
setProperty('iconP2.antialiasing',false)
    ...
    function onCreatePost()
        makeLuaText("message", "Song by Teey3l, chart by Blokbrine", 500, 30, 50)
        setTextAlignment("message", "left")
        addLuaText("message")
  setTextFont('message', 'COMIC.TTF')
     
        makeLuaText("engineText", "Mald Harder - Blokked Engine (OS 1.5.1)", 500, 30, 30)
